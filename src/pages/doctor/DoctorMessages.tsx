...
import { LayoutDashboard, Users, CalendarIcon, MessageSquare, BarChart3, Settings, Paperclip, X, FileText, Send, HeartHandshake, Menu, LogOut } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col lg:flex-row overflow-hidden">
            ...
            <main className="flex-1 overflow-hidden flex flex-col">
                <div className="max-w-6xl flex-1 w-full mx-auto p-4 sm:p-6 lg:p-8 flex flex-col gap-6 min-h-0">
                    <div>
